...
import first.test.com.bscenter.core.engine.service.copy.CopyFileService;
import first.test.com.bscenter.core.engine.service.copy.ICopyFiles;
import first.test.com.bscenter.core.engine.service.copy.SimpleCopyFileCallback;
...
import first.test.com.bscenter.model.NaviInfo;
...
import first.test.com.bscenter.views.CopyBottomChooseBar;
import first.test.com.bscenter.views.DeleteFileDialog;
import first.test.com.bscenter.views.FileInfoDialog;
import first.test.com.bscenter.views.FileListBottomOperatorMenu;
import first.test.com.bscenter.views.FileListBottomToolBar;
import first.test.com.bscenter.views.IOnBottomChooserBarClickListener;
import first.test.com.bscenter.views.IOnDialogBtnClickListener;
import first.test.com.bscenter.views.IOnMenuItemClickListener;
import first.test.com.bscenter.views.MoveBottomChooseBar;
import first.test.com.bscenter.views.NewFileDialog;
import first.test.com.bscenter.views.RenameDialog;
import first.test.com.bscenter.views.SortDialog;
import first.test.com.bscenter.views.SwipListView;
 ...
 * 
 */
public class FileListPageFragment extends Fragment implements SwipListView.OnSwipListItemRemoveListener, OnItemClickListener, IOnBackPressed, OnItemLongClickListener {

    private static final String BIND_STRING = "first.test.com.bscenter.core.engine.service.copy.CopyFileService";
...
//        mFileItems.add();
    ...
    private void setListeners() {
        mAdapter.OnCheckBoxChangedListener(new FileListAdapter.OnCheckBoxChangedListener() {
