package first.test.com.bscenter.core.engine;
...
import first.test.com.bscenter.model.SimplePackgeInfo;
import first.test.com.bscenter.utils.TextUtil;


public class ResourceManager {
    private static ResourceManager mManager = null;
    private Context mContext = MyLeanCloudApp.getAppContext();
    public static final String DATABASES_DIR = "/data/data/first.test.com.bscenter.activity/databases";
    ...
    private static FavoriteDao mDao = DaoFactory.getFavoriteDao(MyLeanCloudApp.getAppContext());
    ...
    public static SimplePackgeInfo getApkPackgageInfo(String archiveFilePath) {
        ...
        PackageManager pm = MyLeanCloudApp.getAppContext().getPackageManager();
    ...
    public static void clearAllFavorite() {
        mDao.clearAll();
        MyLeanCloudApp.initialFavoriteDatabase();
    }
    ...
    public static void removeItem(String path) {
        FavoriteDao dao = DaoFactory.getFavoriteDao(MyLeanCloudApp.getAppContext());
