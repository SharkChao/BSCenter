package first.test.com.bscenter.network;
...
import first.test.com.bscenter.utils.GsonHelper;
import first.test.com.bscenter.utils.StringFetcher;
import io.reactivex.Observable;
import io.reactivex.ObservableSource;
import io.reactivex.functions.Function;
import retrofit2.HttpException;

import static first.test.com.bscenter.constants.Constants.HttpCode.HTTP_NETWORK_ERROR;
import static first.test.com.bscenter.constants.Constants.HttpCode.HTTP_SERVER_ERROR;
import static first.test.com.bscenter.constants.Constants.HttpCode.HTTP_UNAUTHORIZED;
import static first.test.com.bscenter.constants.Constants.HttpCode.HTTP_UNKNOWN_ERROR;
