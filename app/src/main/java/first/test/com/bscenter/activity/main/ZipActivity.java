...
public class ZipActivity extends Activity implements OnItemClickListener, OnItemLongClickListener, OnClickListener {
        ...
        fingerPrinterView.setOnStateChangedListener(new FingerPrinterView.OnStateChangedListener() {
            @Override public void onChange(int state) {
                if (state == FingerPrinterView.STATE_CORRECT_PWD) {
                    Toast.makeText(ZipActivity.this, "指纹识别成功", Toast.LENGTH_SHORT).show();
                    alertDialog.dismiss();
                    setAction();
                }
                if (state == FingerPrinterView.STATE_WRONG_PWD) {
                    Toast.makeText(ZipActivity.this, "指纹识别失败，请重试",
        ...
        DisposableObserver<Boolean> observer = new DisposableObserver<Boolean>() {
            ...
            public void onError(Throwable e) {
                if(e instanceof FPerException){
                    Toast.makeText(ZipActivity.this,((FPerException) e).getDisplayMessage(),Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void showAlert2(){
        ...
        View contentView = LayoutInflater.from(ZipActivity.this).inflate(R.layout.dialog_view2, null);
    ...
    private void actionSecondActivity(LockMode mode) {
        ...
        Intent intent = new Intent(ZipActivity.this, GestureDetailActivity.class);
    ...
    private void showAlert3(){
        AlertDialog.Builder builder = new AlertDialog.Builder(ZipActivity.this);
        View contentView = LayoutInflater.from(ZipActivity.this).inflate(R.layout.dialog_view3, null);
    ...
    private void actionFaceActivity(int value){
        ...
        Intent intent = new Intent(ZipActivity.this,FaceDetailActivity.class);
    ...
    public void showDialog(){
        mPopupWindow1 =
                new PhotoPopupWindow(ZipActivity.this, new OnClickListener() {
            @Override
            public void onClick(View view) {
                showAlert1();
            }
        ...
        View rootView = LayoutInflater.from(ZipActivity.this)
...
//            }
    ...
    public void setAction(){
        ...
        if (null != dao.findFavoriteByFullPath(path)) {
            Toast.makeText(this, "已经在保险箱中了,这个压缩包里面一定有秘密~~", Toast.LENGTH_SHORT).show();
            return;
        }
        File file = new File(path);
