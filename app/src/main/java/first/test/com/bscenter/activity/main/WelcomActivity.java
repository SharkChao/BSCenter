...
import first.test.com.bscenter.views.FeatureAnimationListener;
import first.test.com.bscenter.views.IObservableScrollView;
import first.test.com.bscenter.views.IOnScrollChangedListener;
